            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Kelola<b> Mahasiswa</b></h2>
                            </div>
                            <div class="col-sm-6">
                                <a href='<?php echo base_url("mahasiswa/tambah"); ?>' data-target="#addNewEmployee" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Tambah Mahasiswa</span></a>
                    ...
                    <form method="post" action="<?php echo base_url("mahasiswa/tambah"); ?>">
                        ...
                        <div class="modal-body">                   
                            <div class="form-group">
                                <label>NRP</label>
                                <input type="text" class="form-control" name="input_nim" value="<?php echo set_value('input_nrp'); ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Nama</label>
                            ...
                            <div class="form-group">
                                <label>No. HP</label>
                                <input type="text" class="form-control" name="input_nohp" value="<?php echo set_value('input_nohp'); ?>" required>
                            </div>
                            <div class="form-group">
                                <label>Jurusan</label>
